...
public:
    ...
    void setMat4Transp(const std::string &name, const glm::mat4 &mat) const
    {
        glUniformMatrix4fv(glGetUniformLocation(mProgramID, name.c_str()), 1, GL_TRUE, &mat[0][0]);
    }
    ...
    void checkCompileErrors(unsigned int shader, std::string type)
    {
        ...
        if (type != "PROGRAM") {
            ...
            if (!success) {
                ...
                std::cout << "ERROR::SHADER_COMPILATION_ERROR of tyoe: " << type << "\n" << infoLog << std::endl;
            }
        }
        else {
